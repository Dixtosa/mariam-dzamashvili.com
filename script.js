...
function responsive(e) {
    ...
    e && (winWidth >= breakpoint && ($menu.children(".site-menu").height() + headerHeight + subnavHeight > .75 * winHeight ? $menu.attr("data-height", "full") : $menu.children(".site-menu").height() + headerHeight + subnavHeight > winHeight / 2 ? $menu.attr("data-height", "mid") : $menu.attr("data-height", "half")),
    $(".portrait-image:not([src]):only-child, .landscape-image:not([src]):only-child").addClass("lazyload"),
    winWidth > winHeight ? $(".portrait-image:not(:only-child)").removeClass("lazyload").siblings(".landscape-image:not([src])").addClass("lazyload") : $(".landscape-image:not(:only-child)").removeClass("lazyload").siblings(".portrait-image:not([src])").addClass("lazyload"),
    $("#home-hero").length && safari && $("#home-hero .fullscreen").height(winHeight),
    $("#project-hero").length && ($("#project-hero .fullscreen").height(winHeight),
    $("#project-hero").is(".fall-in") ? $("#project-hero").height(winHeight - subnavHeight) : $("#project-hero").height(winHeight),
    heroHeight = $("#project-hero").height()),
    $("#page-hero").length && (heroMargin = Math.floor((winHeight - $("#hero-text .wrap").innerHeight()) / 2),
    $("#hero-text").css("margin", winHeight + "px auto " + heroMargin + "px")),
    $(".subnav-wrap").length && (subnavPos = Math.floor($(".subnav-wrap").offset().top),
    ($body.is(".touchscreen") || winWidth < winHeight) && (subnavPos -= headerHeight)),
    $(".slideshow-section").length && ($body.is(".touchscreen") || winWidth < winHeight ? $(".slideshow-section .slideshow").height(winHeight - headerHeight - subnavHeight) : $(".slideshow-section .slideshow").height(winHeight - subnavHeight)),
    $(".slick-initialized").length && $(".slick-initialized").find(".slick-dots").each((function() {
    ...
    $(".section-view").length > 1 && ($body.is(".touchscreen") || winWidth < breakpoint ? $sectionViews.css("min-height", winHeight - subnavHeight - headerHeight) : $sectionViews.css("min-height", winHeight - subnavHeight),
    ...
    $projectsGrid.length && $("#project-filters .select-wrap label").each((function() {
        if (winWidth >= 1024) {
            var e = $(this).outerWidth();
            $(this).siblings(".chosen-container").find(".chosen-drop, .chosen-single").css("padding-left", e + "px")
        } else
            $(this).siblings(".chosen-container").find(".chosen-drop, .chosen-single").css("padding-left", "16px")
    }
    )),
...
function constant() {
    ...
    scrollInterval % 10 == 0 && (scrollPos >= lastScrollPos ? $body.addClass("hide-header") : repositioning || $body.removeClass("hide-header"),
    ...
    $body.is('[data-loading="true"]'))
        ...
        if (0 !== heroHeight) {
            if ($("#project-hero").length && scrollPos >= heroHeight - headerHeight || $("#home-hero").length && scrollPos >= heroHeight - headerHeight || scrollPos >= heroHeight - headerHeight ? $header.addClass("opaque") : $header.removeClass("opaque"),
        ...
        $header.addClass("opaque");
    $("#page-hero").length && $("#section-toggle").length ? scrollPos >= subnavPos ? ($body.addClass("subnav-fixed").removeClass("subnav-fixed-bottom"),
    $("#section-toggle button.active").length || $("#section-toggle button:first").addClass("active")) : $("#page-hero").length && scrollPos < winHeight - heroMargin + headerHeight || $("#owner-hero").length && scrollPos < winHeight + headerHeight / 2 ? $body.addClass("subnav-fixed subnav-fixed-bottom") : $body.removeClass("subnav-fixed") : $("#section-toggle").length ? scrollPos >= subnavPos ? ($body.addClass("subnav-fixed").removeClass("subnav-fixed-bottom"),
    $("#section-toggle button.active").length || $("#section-toggle button:first").addClass("active")) : $body.removeClass("subnav-fixed").removeClass("subnav-fixed-bottom") : $body.removeClass("subnav-fixed subnav-fixed-bottom"),
    $projectsGrid.length && (scrollPos >= subnavPos ? ($body.addClass("subnav-fixed"),
    checkedElems || (lazySizes.loader.checkElems(),
    checkedElems = !0)) : $body.removeClass("subnav-fixed")),
    $("[data-video]:not([data-loaded])").length && $("[data-video]:not([data-loaded])").each((function() {
        $(this).parents(".section-view").length && !$(this).parents(".section-view").is(".show") || $(this).parents(".slideshow").length && !$(this).parents(".slick-slide").is(".slick-active") || (secTopPos = $(this).offset().top,
        secHeight = $(this).innerHeight(),
        secBot = secTopPos + secHeight,
        scrollPos >= secTopPos - 1.5 * winHeight && scrollPos <= secBot && loadVideo($(this)))
    }
    )),
    scroll(constant)
}
function anchorHook() {
    $("a").each((function() {
        ...
        if (e.ctrlKey || e.metaKey || $(this).is("[download]"))
            return !0;
        if (e.preventDefault(),
        $(this).is("[data-clear-cookies]") && clearCookies(),
        t.indexOf(".jpg") > -1 || t.indexOf(".jpeg") > -1 || t.indexOf(".png") > -1 || t.indexOf(".gif") > -1) {
            var s;
            s = $(this).is("[data-image-index]") ? $('#modal-slideshow [data-slide-index="' + $(this).attr("data-image-index") + '"]').parents(".slick-slide").attr("data-slick-index") : $('#modal-slideshow [src="' + $(this).attr("href") + '"]').parents(".slick-slide").attr("data-slick-index"),
            ...
            if (t.indexOf("#go-back") > -1)
                ...
                if (targetPage = t.split("#")[0],
                targetHash = t.split("#")[1],
                (targetAnchor = $("#" + targetHash)).is(".hidden-content"))
                    return targetAnchor.slideDown(transTime),
                ...
                if (targetAnchor.is(".section-view")) {
                    ...
                    if (targetAnchor.length && targetPage !== currentState)
                        ...
                        !1;
                    targetPage && targetPage !== currentState && (e.preventDefault(),
                    loadWrap(t))
                }
            } else {
                ...
                if ($(this).is("[data-cover]") && !safari) {
                    ...
                    var n = !1;
                    $(this).find(".landscape-image").length && $(this).find(".portrait-image").length ? ($(this).attr("data-cover") === $(this).find(".landscape-image").attr("data-id") && winWidth > winHeight || $(this).attr("data-cover") === $(this).find(".portrait-image").attr("data-id") && winHeight > winWidth) && (n = !0) : ($(this).find(".landscape-image").length && $(this).attr("data-cover") === $(this).find(".landscape-image").attr("data-id") || $(this).find(".portrait-image").length && $(this).attr("data-cover") === $(this).find(".portrait-image").attr("data-id")) && (n = !0),
                    n ? ($(this).parents(".fullscreen").clone().hide().appendTo($body).addClass("offblack-bg white-text").attr("id", "transition-cover").fadeIn(transTime).find("a").removeAttr("href"),
                    setTimeout((function() {
                        loadWrap(t)
                    }
                    ), transTime)) : loadWrap(t)
                } else
                    $(this).is('[rel="nofollow"]') ? window.open(t, "t", "toolbar=0,resizable=1,status=0,width=600,height=500") : i.test(this.href) && !$(this).is(".post-edit-link") ? loadWrap(t) : -1 === t.indexOf("javascript") && (e.stopPropagation(),
...
function openModal(e) {
    ...
    $(e).find(".modal-close").on("click", (function() {
        closeModal(e)
    }
    )),
    $body.is(".touchscreen") || (setOpen = setTimeout((function() {
        ...
        lazySizes.loader.checkElems(),
        "#slideshow-modal" !== e || $body.is(".touchscreen") || $("#slideshow-modal").find(".slick-active button").focus()
    }
    ), transTime)),
    modalCount++
}
function cleanUp() {
    ...
    iOSSafari || balanceText($(".balance-text"), {
        watch: !0
    }),
    $("h1, h2, h3, h4, q, .intro-text p").not(".widont").each((function() {
...
function initSlideshows() {
    $(".slideshow").each((function() {
        $(this).parents(".section-view").length && !$(this).parents(".section-view").is(".show") || ($(this).is(".slick-initialized") ? $(this).slick("setPosition") : (($(this).parents("#project-hero").length || $(this).parents(".slideshow-section").length) && $(this).on("init", (function() {
            $(this).on("click swipe", (function() {
                if ($(this).parents(".slideshow-section").length) {
                    ...
                    $("#section-toggle").length && scrollPos >= e && (repositioning = !0,
                    setTimeout((function() {
                        scrollPos = e,
                        lastScrollPos = e,
        ...
        $(this).slick({
            ...
            if ($(this).find('.slick-slide:not([data-slick-index="' + i + '"]):not([data-slick-index="' + s + '"]) .slide-image').addClass("hidden"),
            $(this).find('[data-slick-index="' + s + '"] .slide-image.hidden').removeClass("hidden"),
...
function initialize(e) {
    if ($sectionViews = $("#section-views"),
    $projectsGrid = $("#projects-grid"),
    $("#home-hero").length && safari && $("#home-hero .fullscreen a").each((function() {
    ...
    $("#page-hero").length && $("#page-hero").on("click", (function() {
        scrollPos < winHeight - heroMargin ? $htmlBody.stop().animate({
            scrollTop: winHeight - heroMargin
        }, 1.5 * transTime) : $htmlBody.stop().animate({
            scrollTop: heroHeight
        }, 1.5 * transTime)
    }
    )),
    $("#project-hero").length && ($("#transition-cover").length ? ($("#project-hero h1").html($("#transition-cover h1").html()),
    $("#transition-cover button").clone().appendTo("#project-hero .text-wrap"),
    setTimeout((function() {
        responsive(!0),
        $("#transition-cover").remove(),
        $("#project-hero").addClass("fall-in").height(winHeight - subnavHeight)
    }
    ...
    setTimeout((function() {
        ...
        $body.is(".touchscreen") || $("#project-hero .slick-active button").focus(),
    ...
    "" !== projectsList || $.isArray(projectsList) || Cookies.get("project-list"))) {
        ...
        if (s > -1) {
            if (projectsList.length > 0 ? (0 === s ? $("#prev-link").addClass("hidden") : $("#prev-link").attr("href", homeURL + "/?p=" + projectsList[s - 1]),
            s === projectsList.length - 1 ? $("#next-link").addClass("hidden") : $("#next-link").attr("href", homeURL + "/?p=" + projectsList[s + 1])) : $("#prev-link, #next-link").addClass("hidden"),
            (cookieFilters = Cookies.getJSON("filters")).length > -1)
                for (i = 0; i < cookieFilters.length; i++)
                    "sort" !== (filterName = cookieFilters[i].split("=")[0]) && $("#projects-nav #project-" + filterName).text(filterName + ": " + cookieFilters[i].split("=")[1])
        } else
            clearCookies()
    }
    var o, n;
    $sectionViews.length ? $(".section-view").length > 1 ? ($sectionViews.next().length && $sectionViews.next().hide().clone().appendTo(".section-view").show(),
    $footer.clone().appendTo(".section-view").show(),
    $(".section-view:not(.show)").hide(),
    $("#section-toggle button").on("click", (function() {
        o = $(this).index() + 1,
        $(this).is(".active") || ($(this).addClass("active").siblings().removeClass("active"),
        $(".section-view.show").fadeOut(transTime / 2).removeClass("show"),
        setTimeout((function() {
            $(".section-view:nth-child(" + o + ")").fadeIn(transTime / 2).addClass("show"),
            $(".slideshow").length && initSlideshows(),
            $("#page-hero").length && (window.location.hash = $(".section-view:nth-child(" + o + ")").attr("id"),
            stateData = {
    ...
    ), 2)) : $(".section-view:first").show().addClass("show")) : ($(".subnav-wrap").remove(),
    $footer.clone().appendTo($contentWrap).show()) : $footer.clone().appendTo($contentWrap).show();
    $(".video-wrap").length && $(".video-wrap").each((function() {
        $(this).find(".play-toggle").on("click", (function() {
            ...
            $(this).parents(".video-wrap").is(".playing.paused") ? ($(this).parents(".video-wrap").removeClass("paused"),
            n.play()) : ($(".video-wrap.playing").length && $(".video-wrap.playing").removeClass("playing paused").children("video").get(0).pause(),
            $(this).parents(".video-wrap").removeClass("paused").addClass("playing"),
            n.play()),
            $(this).siblings("video").on("click", (function() {
    ...
    $("#ok-form").length && ($("[data-subject], .hidden-fields").hide(),
    ...
    $("#ok-form").submit((function(e) {
        ...
        $.ajax({
            ...
            "" !== e.responseText ? $("#form-response").text(e.responseText) : $("#form-response").text("Please try button again!")
        }
        ))
    }
    ))),
    ...
    $(".split-section").length && setTimeout((function() {
        $(window).trigger("resize")
    }
    ), 2 * transTime),
    isPopState ? console.log("init via popstate") : (e && e.indexOf("#") > -1 || "" !== window.location.hash) && ((targetHash = window.location.hash) || (targetHash = "#" + e.split("#")[1]),
    targetHash.indexOf("?") > -1 && (targetHash = targetHash.split("?")[0]),
    (targetAnchor = $(targetHash)).length && !targetAnchor.is(".section-view") && ($(document).scrollTop(targetAnchor.offset().top),
...
function alignToSubnav() {
    scrollPos < subnavPos ? $htmlBody.stop().animate({
        scrollTop: subnavPos
    }, transTime) : (repositioning = !0,
    setTimeout((function() {
        $body.addClass("hide-header"),
        $(document).scrollTop(subnavPos + 1)
    }
    ), transTime / 2 + 1),
    setTimeout((function() {
...
function initProjects() {
    ...
    ($body.is(".touchscreen") || winWidth < breakpoint) && $('#project-filters option[value="all"]').each((function() {
    ...
    $.ajax(homeURL + projectsPath).done((function(e) {
        ...
        Cookies.get("project-list") ? (storedProjectsList = Cookies.get("project-list"),
        storedListSet = !1) : "" !== projectsList ? (storedProjectsList = projectsList,
        storedListSet = !1) : storedProjectsList = "";
        var t = !1;
        ...
        $("#projects-sort").on("click", (function(e) {
            ...
            $("#projects-sort").is(".active") ? ($("#projects-sort").removeClass("active"),
            setTimeout((function() {
                sortProjects("" === filterAttrs ? "position" : "last-position")
            }
            ), transTime / 2)) : ($("#projects-sort").addClass("active"),
            setTimeout((function() {
                sortProjects("title")
            }
            ), transTime / 2)),
            ...
            void 0 !== e.originalEvent && (alignToSubnav(),
            storedListSet = !0)
        }
        )),
        ...
        $("#projects-sort").is(".set-active") && (clearCookies(),
        ...
        Cookies.getJSON("filters") && (cookieFilters = Cookies.getJSON("filters")).length > -1)
            for (i = 0; i < cookieFilters.length; i++)
                "sort" === (filterName = cookieFilters[i].split("=")[0]) ? $("#projects-sort").trigger("click") : $('#project-filters select[id="select-' + filterName + '"]').val(cookieFilters[i].split("=")[1]).trigger("change").trigger("chosen:updated");
...
function makeCookies() {
    ...
    $.isEmptyObject(filtersList))
        ...
        i = 0; i < cookieFilters.length; i++)
            updateQueryString(filterName = cookieFilters[i].split("=")[0], cookieFilters[i].split("=")[1]),
            "sort" !== filterName && $('#project-filters select:not([id="select-' + filterName + '"])').each((function() {
                "all" === $(this).val() && (filterName = $(this).attr("id").split("-")[1],
                $(this).find('option:not([selected]):not([value="all"])').each((function() {
                    $(".grid-item.show[data-" + filterName + 's*="' + $(this).attr("value") + '"]').length ? $(this).removeAttr("disabled") : $(this).attr("disabled", ""),
...
function updateQueryString(e, t) {
    ...
    e && t) {
        ...
        window.history.replaceState(stateData, pageName, currentState)
}
function filterGrid() {
    $projectsGrid.addClass("filtering"),
    filterAttrs = "",
    ...
    $("#project-filters select").each((function() {
        ...
        "all" !== $(this).val() && (filterAttrs += "[data-" + $(this).attr("id").split("-")[1] + 's*="' + $(this).val() + '"]')
    }
    )),
    setTimeout((function() {
        if ("" === storedProjectsList || storedListSet)
            "" === filterAttrs ? ($projects.addClass("show"),
            $("#projects-sort").is("active") ? sortProjects("title") : sortProjects("position"),
            itemCount = $("#projects-grid .grid-item").length) : ($projects.each((function() {
                $(this).removeClass("show"),
                $(this).is(filterAttrs) && (itemCount++,
                $(this).attr("data-last-position", itemCount).addClass("show"))
            }
            )),
            ...
            if (console.log("storedProjectsList", storedProjectsList),
            $.isArray(storedProjectsList) || (storedProjectsList = storedProjectsList.split(",").map(Number)),
            storedProjectsList.length > 0) {
                for (i = 0; i < storedProjectsList.length; i++)
                    $('.grid-item[data-id="' + storedProjectsList[i] + '"]').attr("data-stored-sort", i).addClass("show");
                $(".grid-item:not([data-stored-sort])").attr("data-stored-sort", storedProjectsList.length + 1).removeClass("show")
            }
            itemCount = storedProjectsList.length,
            sortProjects("stored-sort")
        }
    }
    ), transTime / 2),
    setTimeout((function() {
...
function loadWrap(e) {
    $contentWrap.focus(),
    "Win16" === platform || "Windows 95" === platform || "Win95" === platform || "Windows_95" === platform || "Windows 98" === platform || "Win98" === platform || "Windows NT 5.0" === platform || "Windows 2000" === platform || "Windows NT 5.1" === platform || "Windows XP" === platform || "Windows NT 5.2" === platform ? window.location.href = e : ($body.removeClass("hide-header").attr("data-loading", "true"),
    ...
    setTimeout((function() {
        ...
        $.ajax(e).done((function(t) {
            ...
            isPopState ? isPopState = !1 : (stateData = {
                path: currentState,
                scrollTop: scrollPos
            },
            ...
            ++attempts < 7 ? setTimeout(loadWrap(e), 1e3) : (openModal("#error-modal"),
            $header.addClass("opaque"))
        }
        ))
    }
...
!function(e, t) {
    ...
    if (i.getElementsByClassName) {
        var s, o, n = i.documentElement, r = t.Date, l = t.HTMLPictureElement, a = "addEventListener", c = "getAttribute", d = t.addEventListener, h = t.setTimeout, u = t.requestAnimationFrame || h, p = t.requestIdleCallback, f = /^picture$/i, g = ["load", "error", "lazyincluded", "_lazyloaded"], m = {}, v = Array.prototype.forEach, _ = function(e, t) {
            ...
            var s;
            !l && (s = t.picturefill || o.pf) ? (i && i.src && !e.getAttribute("srcset") && e.setAttribute("srcset", i.src),
            s({
                reevaluate: !0,
                elements: [e]
            })) : i && i.src && (e.src = i.src)
        ...
        ,
        E = function(e, t) {
            j && !t ? e.apply(this, arguments) : (O.push(e),
            H || (H = !0,
            (i.hidden ? h : u)(z)))
        }
        ,
        E._lsFlush = z,
        E), j, H, A, P, O, z, E, L = function(e, t) {
            return t ? function() {
                x(e)
            }
            : function() {
        ...
        ,
        ne = function(e) {
            return null == K && (K = "hidden" == S(i.body, "visibility")),
            K || "hidden" != S(e.parentNode, "visibility") && "hidden" != S(e, "visibility")
        }
        ,
        re = function(e, t) {
            var s, o = e, r = ne(e);
            ...
            V += t,
            G -= t,
            Y += t; r && (o = o.offsetParent) && o != i.body && o != n; )
                (r = (S(o, "opacity") || 1) > 0) && "visible" != S(o, "overflow") && (s = o.getBoundingClientRect(),
                r = Y > s.left && G < s.right && V > s.top - 1 && X < s.bottom + 1);
            return r
        }
        ,
        le = function() {
            ...
            if ((F = o.loadMode) && ie < 8 && (e = m.length)) {
                ...
                g = o.hFac,
                K = null,
                te < f && ie < 1 && se > 2 && F > 2 && !i.hidden ? (te = f,
                se = 0) : te = F > 1 && se > 1 && ie < 6 ? p : 0; t < e; t++)
                    if (m[t] && !m[t]._lazyRace)
                        if (Z)
                            if ((h = m[t].getAttribute("data-expand")) && (c = 1 * h) || (c = te),
                            u !== c && (B = innerWidth + c * g,
                            U = innerHeight + c,
                            d = -1 * c,
                            u = c),
                            ...
                            (V = r.bottom) >= d && (X = r.top) <= U && (Y = r.right) >= d * g && (G = r.left) <= B && (V || Y || G || X) && (o.loadHidden || ne(m[t])) && (D && ie < 3 && !h && (F < 3 || se < 4) || re(m[t], c))) {
                                ...
                                !a && D && !l && ie < 4 && se < 4 && F > 2 && (I[0] || o.preloadAfterLoad) && (I[0] || !h && (V || Y || G || X || "auto" != m[t].getAttribute(o.sizesAttr))) && (l = I[0] || m[t]);
                        else
                            ge(m[t]);
                l && !a && ge(l)
            }
        ...
        fe = L((function(e, t, i, s, n) {
            var r, l, a, c, d, u;
            (d = k(e, "lazybeforeunveil", t)).defaultPrevented || (s && (i ? w(e, o.autosizesClass) : e.setAttribute("sizes", s)),
            ...
            y(e, o.lazyClass),
            x((function() {
                (!u || e.complete && e.naturalWidth > 1) && (u ? oe(d) : ie--,
                ce(d))
            }
            ), !0)
        }
        ...
        ,
        {
            _: function() {
                ...
                d("scroll", ae, !0),
                d("resize", ae, !0),
                t.MutationObserver ? new MutationObserver(ae).observe(n, {
                    childList: !0,
                    subtree: !0,
                    attributes: !0
                ...
                /d$|^c/.test(i.readyState) ? me() : (d("load", me),
                i.addEventListener("DOMContentLoaded", ae),
                h(me, 2e4)),
                s.elements.length ? (le(),
                x._lsFlush()) : ae()
            },
            checkElems: ae,
            unveil: ge = function(e) {
                var t, i = J.test(e.nodeName), s = i && (e.getAttribute(o.sizesAttr) || e.getAttribute("sizes")), n = "auto" == s;
                (!n && D || !i || !e.getAttribute("src") && !e.srcset || e.complete || _(e, o.errorClass) || !_(e, o.lazyClass)) && (t = k(e, "lazyunveilread").detail,
                n && ve.updateElem(e, !0, e.offsetWidth),
                e._lazyRace = !0,
                ie++,
                fe(e, t, n, s, i))
            }
        }), I, D, q, F, R, B, U, X, G, Y, V, K, J, Q, Z, ee, te, ie, se, oe, ne, re, le, ae, ce, de, he, ue, pe, fe, ge, me, ve = (we = L((function(e, t, i, s) {
            var o, n, r;
            ...
            f.test(t.nodeName || ""))
                for (n = 0,
                r = (o = t.getElementsByTagName("source")).length; n < r; n++)
        ...
        {
            _: function() {
                _e = i.getElementsByClassName(o.autosizesClass),
                d("resize", be)
            },
            checkElems: be = W($e),
            updateElem: ye
...
var objectFitImages = function() {
    ...
    function i(e) {
        for (var t = getComputedStyle(e).fontFamily, i, s = {}; null !== (i = d.exec(t)); )
            s[i[1]] = i[2];
        return s
    }
    function s(t, i, s) {
    ...
    function n(e) {
        ...
        !l.img) {
            if ("fill" === n["object-fit"])
                return;
            if (!l.skipTest && u && !n["object-position"])
                return
        }
        if (!l.img) {
        ...
        /scale-down/.test(n["object-fit"]) ? o(l.img, (function() {
    ...
    function r(e) {
        var t = {
            ...
            set: function t(i, s) {
                return e[c].img[s || "src"] = i,
                v.call(e, "data-ofi-" + s, i),
                n(e),
                i
            }
        };
...
!function(e, t) {
    ...
    function s(e, t, i) {
        ...
        return function o() {
            ...
            var r = this
              , l = arguments;
            s ? clearTimeout(s) : i && e.apply(r, l),
            s = setTimeout(n, t || 100)
        }
    }
    function o() {
    ...
    function l(e, i) {
        ...
        if (e.nodeType === e.ELEMENT_NODE)
            ...
            e.nodeType === e.COMMENT_NODE ? C += e.length + 7 : e.nodeType === e.PROCESSING_INSTRUCTION_NODE ? C += e.length + 2 : C += e.length
    }
    function a(e, t, i) {
        if (0 === i)
    ...
    function d(e, t, i) {
        ...
        t += " ",
        r < 2 ? t : ((n = document.createElement("span")).innerHTML = t,
        e.appendChild(n),
        o = n.offsetWidth,
    ...
    function p(e, t, i, s, o, n, r) {
        ...
        if (t && "string" == typeof t)
            for (; ; ) {
                for (; !u(t, n); )
                    n += o;
                if (e.innerHTML = t.substr(0, n),
                l = e.offsetWidth,
                o < 0) {
                    if (l <= s || l <= 0 || 0 === n)
                        break
                } else if (s <= l || i <= l || n === t.length)
                    break;
                n += o
            }
        r.index = n,
        ...
        t(g(e), (function(e) {
            ...
            if (h > 0 && g > h && g < t) {
                for (var _ = e.innerHTML, w = "", y = "", b = A(e), k, S = Math.round(u / m), C = 0, x, j, H, P, O, z, E; S > 1; )
                    ...
                    b ? w += d(e, y, h) : (w += y,
                    w += (z = E || Boolean(y.match(/(-|\u2014|\u2013)$/))) ? '<br data-owner="balance-text-hyphen" />' : '<br data-owner="balance-text" />'),
                    _ = _.substr(O),
                    C = O,
                    S--,
                    e.innerHTML = _,
...
function() {
    ...
    t = function() {
        ...
        e.prototype.results_option_build = function(e) {
            ...
            l = 0,
            o = 0,
            n = (r = this.results_data).length; o < n && (s = "",
            "" !== (s = (i = r[o]).group ? this.result_add_group(i) : this.result_add_option(i)) && (l++,
            t += s),
        ...
        e.prototype.reset_single_select_options = function() {
            ...
            for (o = [],
            e = 0,
            t = (i = this.results_data).length; e < t; e++)
        ...
        e.prototype.winnow_results = function() {
            ...
            i = 0,
            s = (l = this.results_data).length; i < s; i++)
                ...
                o.group && !this.group_search || (h = this.search_string_match(f, a),
                o.search_match = null != h,
                o.search_match && !o.group && (c += 1),
                o.search_match ? (r.length && (u = h.index,
                n = f.slice(0, u),
    ...
    i = function(i) {
        ...
        o.prototype.search_field_scale = function() {
            ...
            if (this.is_multiple) {
                ...
                i = 0,
                s = (r = ["fontSize", "fontStyle", "fontWeight", "fontFamily", "lineHeight", "textTransform", "letterSpacing"]).length; i < s; i++)
...
function(e) {
    ...
    e.prototype.animateSlide = function(e, t) {
        ...
        $({
            ...
            step: function(e) {
                e = Math.ceil(e),
                !1 === s.options.vertical ? (i[s.animType] = "translate(" + e + "px, 0px)",
                s.$slideTrack.css(i)) : (i[s.animType] = "translate(0px," + e + "px)",
                s.$slideTrack.css(i))
            },
            complete: function() {
                t && t.call()
    ...
    e.prototype.checkResponsive = function(e, t) {
        ...
        if ("window" === i.respondTo ? n = a : "slider" === i.respondTo ? n = l : "min" === i.respondTo && (n = Math.min(a, l)),
        i.options.responsive && i.options.responsive.length && null !== i.options.responsive) {
            for (s in o = null,
            i.breakpoints)
                i.breakpoints.hasOwnProperty(s) && (!1 === i.originalSettings.mobileFirst ? n < i.breakpoints[s] && (o = i.breakpoints[s]) : n > i.breakpoints[s] && (o = i.breakpoints[s]));
            null !== o ? null !== i.activeBreakpoint ? (o !== i.activeBreakpoint || t) && (i.activeBreakpoint = o,
            "unslick" === i.breakpointSettings[o] ? i.unslick(o) : (i.options = $.extend({}, i.originalSettings, i.breakpointSettings[o]),
            !0 === e && (i.currentSlide = i.options.initialSlide),
            i.refresh(e)),
            r = o) : (i.activeBreakpoint = o,
            "unslick" === i.breakpointSettings[o] ? i.unslick(o) : (i.options = $.extend({}, i.originalSettings, i.breakpointSettings[o]),
            !0 === e && (i.currentSlide = i.options.initialSlide),
            i.refresh(e)),
            r = o) : null !== i.activeBreakpoint && (i.activeBreakpoint = null,
    ...
    e.prototype.changeSlide = function(e, t) {
        ...
        o = (r = i.slideCount % i.options.slidesToScroll != 0) ? 0 : (i.slideCount - i.currentSlide) % i.options.slidesToScroll,
        e.data.message) {
        case "previous":
            n = 0 === o ? i.options.slidesToScroll : i.options.slidesToShow - o,
            i.slideCount > i.options.slidesToShow && i.slideHandler(i.currentSlide - n, !1, t);
            break;
        case "next":
    ...
    e.prototype.getSlideCount = function() {
        var e = this, t, i, s, o;
        return o = !0 === e.options.centerMode ? Math.floor(e.$list.width() / 2) : 0,
        s = -1 * e.swipeLeft + o,
        !0 === e.options.swipeToSlide ? (e.$slideTrack.find(".slick-slide").each((function(t, o) {
            var n, r, l;
            if (n = $(o).outerWidth(),
            r = o.offsetLeft,
    ...
    e.prototype.lazyLoad = function() {
        ...
        var t = this, i, s, o, n;
        if (!0 === t.options.centerMode ? !0 === t.options.infinite ? n = (o = t.currentSlide + (t.options.slidesToShow / 2 + 1)) + t.options.slidesToShow + 2 : (o = Math.max(0, t.currentSlide - (t.options.slidesToShow / 2 + 1)),
        n = t.options.slidesToShow / 2 + 1 + 2 + t.currentSlide) : (o = t.options.infinite ? t.options.slidesToShow + t.currentSlide : t.currentSlide,
        ...
        "anticipated" === t.options.lazyLoad)
            for (var r = o - 1, l = n, a = t.$slider.find(".slick-slide"), c = 0; c < t.options.slidesToScroll; c++)
                r < 0 && (r = t.slideCount - 1),
                i = (i = i.add(a.eq(r))).add(a.eq(l)),
                r--,
                l++;
        e(i),
        t.slideCount <= t.options.slidesToShow ? e(s = t.$slider.find(".slick-slide")) : t.currentSlide >= t.slideCount - t.options.slidesToShow ? e(s = t.$slider.find(".slick-cloned").slice(0, t.options.slidesToShow)) : 0 === t.currentSlide && e(s = t.$slider.find(".slick-cloned").slice(-1 * t.options.slidesToShow))
    }
    ,
    ...
    e.prototype.registerBreakpoints = function() {
        ...
        if ("array" === $.type(o) && o.length) {
            ...
            o)
                if (s = e.breakpoints.length - 1,
                o.hasOwnProperty(t)) {
                    for (i = o[t].breakpoint; s >= 0; )
                        e.breakpoints[s] && e.breakpoints[s] === i && e.breakpoints.splice(s, 1),
                        s--;
                    e.breakpoints.push(i),
                    e.breakpointSettings[i] = o[t].settings
                }
    ...
    e.prototype.setCSS = function(e) {
        ...
        !1 === t.cssTransitions ? (i[t.animType] = "translate(" + s + ", " + o + ")",
        t.$slideTrack.css(i)) : (i[t.animType] = "translate3d(" + s + ", " + o + ", 0px)",
        t.$slideTrack.css(i)))
    }
    ,
    ...
    e.prototype.setOption = e.prototype.slickSetOption = function(e, t, i) {
        ...
        if ("object" === $.type(e) ? (r = e,
        a = t,
        c = "multiple") : "string" === $.type(e) && (r = e,
        l = t,
        a = i,
        "responsive" === e && "array" === $.type(t) ? c = "responsive" : void 0 !== t && (c = "single")),
        "single" === c)
            s.options[r] = l;
        else if ("multiple" === c)
            $.each(r, (function(e, t) {
            ...
            for (n in l)
                if ("array" !== $.type(s.options.responsive))
                    ...
                    for (o = s.options.responsive.length - 1; o >= 0; )
                        s.options.responsive[o].breakpoint === l[n].breakpoint && s.options.responsive.splice(o, 1),
                        o--;
    ...
    e.prototype.setSlideClasses = function(e) {
        var t = this, i, s, o, n;
        if (s = t.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"),
        ...
        !0 === t.options.centerMode) {
            ...
            e >= 0 && e <= t.slideCount - t.options.slidesToShow ? t.$slides.slice(e, e + t.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : s.length <= t.options.slidesToShow ? s.addClass("slick-active").attr("aria-hidden", "false") : (n = t.slideCount % t.options.slidesToShow,
            o = !0 === t.options.infinite ? t.options.slidesToShow + e : e,
            t.options.slidesToShow == t.options.slidesToScroll && t.slideCount - e < t.options.slidesToShow ? s.slice(o - (t.options.slidesToShow - n), o + n).addClass("slick-active").attr("aria-hidden", "false") : s.slice(o, o + t.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
    ...
    e.prototype.setupInfinite = function() {
        ...
        !0 === e.options.infinite && !1 === e.options.fade && (i = null,
        e.slideCount > e.options.slidesToShow)) {
            for (s = !0 === e.options.centerMode ? e.options.slidesToShow + 1 : e.options.slidesToShow,
            t = e.slideCount; t > e.slideCount - s; t -= 1)
                i = t - 1,
    ...
    e.prototype.slideHandler = function(e, t, i) {
        ...
        !(!0 === a.animating && !0 === a.options.waitForAnimate || !0 === a.options.fade && a.currentSlide === e))
            ...
            !1 === a.options.infinite && !1 === a.options.centerMode && (e < 0 || e > a.getDotCount() * a.options.slidesToScroll))
                !1 === a.options.fade && (s = a.currentSlide,
                !0 !== i && a.slideCount > a.options.slidesToShow ? a.animateSlide(r, (function() {
                    a.postSlide(s)
                }
                )) : a.postSlide(s));
                ...
                o = s < 0 ? a.slideCount % a.options.slidesToScroll != 0 ? a.slideCount - a.slideCount % a.options.slidesToScroll : a.slideCount + s : s >= a.slideCount ? a.slideCount % a.options.slidesToScroll != 0 ? 0 : s - a.slideCount : s,
                a.animating = !0,
    ...
    e.prototype.swipeMove = function(e) {
        ...
        !(!t.dragging || t.scrolling || l && 1 !== l.length) && (s = t.getLeft(t.currentSlide),
        ...
        !t.options.verticalSwiping && !t.swiping && a > 4 ? (t.scrolling = !0,
        !1) : (!0 === t.options.verticalSwiping && (t.touchObject.swipeLength = a),
        o = t.swipeDirection(),
        ...
        !1 === t.options.infinite && (0 === t.currentSlide && "right" === o || t.currentSlide >= t.getDotCount() && "left" === o) && (n = t.touchObject.swipeLength * t.options.edgeFriction,
    ...
    $.fn.slick = function(t) {
        ...
        for (r = 0; r < n; r++)
            if ("object" == typeof s || void 0 === s ? i[r].slick = new e(i[r],s) : l = i[r].slick[s].apply(i[r].slick, o),
            void 0 !== l)
                return l;
        return i
    }
...
function(e) {
    ...
    function o(e) {
        ...
        l.filter.call(this, e) && i in y)
            for (c = p(),
            r = 0; r < y[i].length; r++)
                if ((o = y[i][r]).scope == c || "all" == o.scope) {
                    for (n in a = o.mods.length > 0,
                    b)
                        (!b[n] && t(o.mods, +n) > -1 || b[n] && -1 == t(o.mods, +n)) && (a = !1);
                    (0 != o.mods.length || b[16] || b[18] || b[17] || b[91]) && !a || !1 === o.method(e, o) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1,
    ...
    var e = "undefined" != typeof window && void 0 !== window.document ? window.document : {}
      ...
      , n = {
        request: function(t) {
            ...
            / Version\/5\.1(?:\.\d+)? Safari\//.test(navigator.userAgent) ? t[o]() : t[o](i ? Element.ALLOW_KEYBOARD_INPUT : {})
        },
        exit: function() {
            e[s.exitFullscreen]()
        },
...
$(document).on("lazybeforeunveil", (function(e) {
    ...
    lazyInitThrottle = setTimeout((function() {
        !iPad && $(e.target).parents(".slide-image").length && $(e.target).parents(".slick-slide").next().find(".slide-image.hidden").length && $(e.target).parents(".slick-slide").next().find(".slide-image.hidden").removeClass("hidden"),
        responsive(!1)
    }
    ), 150)
}
...
$(document).ready((function() {
    var e;
    analyticsID && (gaTracker(analyticsID),
    gaTrack(currentState, pageName.split(" — ")[1])),
    responsive(!1),
    $footer.hide(),
    ...
    $("#search-input").data("oldVal", $(this).val()).bind("propertychange change keyup input paste", (function() {
        ...
        $(this).is(":focus") && ("" === (e = $(this).val()) || " " === e || e.length < 3 ? ($("#search").removeClass("has-results"),
        $("#search-results").empty()) : $(this).data("oldVal") !== e && ($("#search").addClass("has-results"),
    ...
    window.onkeydown = function(e) {
        if (27 === e.keyCode)
            if ($(".modal.show").length) {
                ...
                menuOpen ? closeMenu() : searchOpen && closeSearch()
    }
    ,
    stateData = {
        path: currentState,
...
window.addEventListener("popstate", (function(e) {
    if (e.state) {
        var t = e.state.path;
        isPopState || -1 !== t.indexOf("?s=") ? null !== e.state && (window.location = t) : (e.preventDefault(),
        isPopState = !0,
